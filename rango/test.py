...
class Chapter4IndexPageTests(TestCase):
    ...
    def test_index_uses_context_dictionary(self):
        """
        Tests whether the index view uses the context dictionary correctly.http://localhost:8888/notebooks/Workspace/tango_with_django_project/Untitled.ipynb?kernel_name=python3#
